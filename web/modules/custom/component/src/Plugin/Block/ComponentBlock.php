...
class ComponentBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *   The UUID service.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, UuidInterface $uuid_service) {
  ...
  public function build() {
    ...
    // Add cache settings. These can be managed from the component.yml file.
   ...
   *   configuration options from the CMS. We pass the component
   *   configuration into the DOM through the data attributes in the wrapper
   *   around the component HTML.
   */
  protected function buildAttributes() {
    $component = $this->component;
    // @todo Fix unique id and name should be set on the object and generated
